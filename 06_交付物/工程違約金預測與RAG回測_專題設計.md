...
- 已依 2021-2024 訓練、2025 驗證、2026 測試輸出 majority baseline、關鍵詞規則 baseline 與 Logistic Regression 結果。
...
AI 假設版回測已產出於 `06_交付物/is_reduced_classification/`，另保留同結果副本於 `06_交付物/is_reduced_classification_ai_assumed/`。在 2026 測試集 5 件中，Logistic Regression 的 Accuracy 為 0.400、F1-score 為 0.571、ROC-AUC 為 0.333；此結果樣本極小，僅作流程驗證，不宜作為模型有效性結論。
...
- 已依 2021-2024 訓練、2025 驗證、2026 測試輸出 mean baseline、Ridge Regression 與 Lasso Regression 的 MAE、RMSE、R² 與分段命中率。
...
AI 假設版比例回測已產出於 `06_交付物/reduction_ratio_model/`，另保留同結果副本於 `06_交付物/reduction_ratio_model_ai_assumed/`。在 2026 測試集 5 件中，Ridge Regression 的 MAE 為 0.2285、RMSE 為 0.3108、R² 為 -0.8637、分段命中率為 0.600；Lasso Regression 的 MAE 為 0.2189、RMSE 為 0.2919、R² 為 -0.6434、分段命中率為 0.600。此結果仍屬 AI 假設標註下的暫行 smoke test。
